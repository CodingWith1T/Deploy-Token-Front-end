...
const footerLinks = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Create Token on Soneium', path: '/create-token/soneium' },
      { name: 'Multichain Balance Checker', path: '/tools/multi-chain-balance-checker' },
      { name: 'Chain List', path: '/tools/chainlist' },
      { name: 'Crypto Affiliate Program', path: '#' },
      // { name: 'Create Avalanche Token', path: '/create-token/Avalanche' },
...

  {
    ...
    items: [
      ...
      { name: 'How to Create Token on Sonic', path: 'https://blog.deploytokens.com/blog/how-to-create-a-token-on-sonic-in-seconds-without-coding-complete-beginners-guide/' },
      { name: 'How to Create Token on Arbitrum', path: 'https://blog.deploytokens.com/blog/5-steps-to-create-a-token-on-arbitrum/' },
      { name: 'How to Create Token on Polygon', path: 'https://blog.deploytokens.com/blog/create-your-polygon-erc20-token-in-seconds-without-coding-2025-guide/' },
      { name: 'How to Create Token on Blast', path: 'https://blog.deploytokens.com/blog/how-to-create-token-on-blast-in-1-minute-without-coding/' },
